  ...
  <div class="app">
    ...
    <main>
      ...
      <template v-else-if="prof">
        ...
        <p v-if="(prof.person as any).links?.linkedin || (prof.person as any).links?.email || (prof.person as any).links?.github" class="contact mono">
          <a v-if="(prof.person as any).links.linkedin" :href="(prof.person as any).links.linkedin" target="_blank" rel="noopener noreferrer">
            <svg viewBox="0 0 24 24" width="15" height="15" aria-hidden="true"><path fill="currentColor" d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zM7.119 20.452H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/></svg>
            <span>LinkedIn</span>
          </a>
          <a v-if="(prof.person as any).links.email" :href="`mailto:${(prof.person as any).links.email}`">
            <svg viewBox="0 0 24 24" width="15" height="15" aria-hidden="true"><path fill="currentColor" d="M20 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4-8 5-8-5V6l8 5 8-5v2z"/></svg>
            <span>Email</span>
          </a>
          <a v-if="(prof.person as any).links.github" :href="(prof.person as any).links.github" target="_blank" rel="noopener noreferrer">
...
.contact a { display: inline-flex; align-items: center; gap: 0.35rem; color: var(--text-muted); text-decoration: none; border-bottom: 1px dashed var(--border); }

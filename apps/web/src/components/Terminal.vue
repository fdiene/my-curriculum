    ...
    <main>
      ...
      <template v-else-if="prof">
        ...
        <p v-if="(prof.person as any).links?.linkedin || (prof.person as any).links?.email || (prof.person as any).links?.github" class="contact mono">
          <a v-if="(prof.person as any).links.linkedin" :href="(prof.person as any).links.linkedin" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" title="LinkedIn">
          ...
          <a v-if="(prof.person as any).links.email" :href="`mailto:${(prof.person as any).links.email}`" aria-label="Email" title="Email">
          ...
          <a v-if="(prof.person as any).links.github" :href="(prof.person as any).links.github" target="_blank" rel="noopener noreferrer" aria-label="GitHub" title="GitHub">
